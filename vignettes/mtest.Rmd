...
The m-test allows the calculation of the p-value of this result 
...
*red*) must be the same in every draw from the same urn (condition 3). This 
means that the ball drawn must be returned to the urn before the next 
extraction.

Suppose we get these results after 9 draws in Urns1-3 and 6 draws in Urn3:

| Outcome             | Urn1 | Urn2 | Urn3 | Urn3 |
|--------------------:|:----:|:----:|:----:|:----:|
| Red                 | 3    |  4   | 1    | 3    |
| Green               | 3    |  5   | 2    | 2    |
| Blue                | 3    |  0   | 6    | 1    |
