...
Therefore, we can reject the null hypothesis. For stronger evidence, we can 
also use `m.test` to reject the null hypothesis that both probabilities are 
equal and accept the alternative hypothesis that the probability of success 
is higher in the `Surgery` group.
