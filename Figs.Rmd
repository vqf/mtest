...
p1 <- plot3D::persp3D(z=z, x=s1, y=s2, theta = 155, phi = 35, ticktype='detailed', bty='b2', xlab='s1', ylab='s2', zlab='\n\nP')
p2 <- plot3D::persp3D(z=z2, x=s1, y=s2, theta = 145, phi = 35, ticktype='detailed', bty='b2', xlab='s1', ylab='s2', zlab='\n\nP')
